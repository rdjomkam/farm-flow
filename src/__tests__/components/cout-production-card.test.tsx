...
vi.mock("next-intl", () => ({
  useTranslations: (ns?: string) => (key: string) => {
    ...
    const map: Record<string, string> = {
      ...
      "empty": "Aucun coût enregistré pour cette vague.",
      "exportPdf": "Exporter PDF",
      "expandLabel": "Voir le détail",
      "collapseLabel": "Réduire le détail",
      "summary.coutTotal": "Coût total",
      "summary.coutParKg": "Coût / kg",
      "summary.prixVenteKg": "Prix vente / kg",
      "summary.margeParKg": "Marge / kg",
      "summary.roi": "ROI",
      "sections.bilanProduction": "Bilan production",
      "sections.bilanProductionDesc": "Biomasse totale produite = vivante + vendue",
      "sections.repartitionCategorie": "Répartition par catégorie",
      ...
      "sections.depensesPartageesDesc": "Coûts communs répartis au prorata de cette vague",
      "sections.depensesRecurrentes": "Dépenses récurrentes",
      "sections.depensesRecurrentesDesc": "Charges fixes imputées selon le ratio jours × poissons",
      "sections.rentabilite": "Rentabilité",
      "sections.rentabiliteDesc": "Comparaison coûts de production vs revenus des ventes",
      "bilan.biomasseProduite": "Biomasse produite",

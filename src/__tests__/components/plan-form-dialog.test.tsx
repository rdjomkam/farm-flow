...
const dialogTranslations: Record<string, string> = {
  ...
  "admin.serverError": "Une erreur est survenue.",
  "admin.activePlan": "Plan actif",
  "admin.activePlanHint": "Activer ou désactiver ce plan.",
  "admin.publicPlan": "Plan public",
  "admin.publicPlanHint": "Rendre ce plan visible publiquement.",
  "admin.form.nameLabel": "Nom du plan",
  "admin.form.namePlaceholder": "Ex : Plan Éleveur Standard",
  "admin.form.nameRequired": "Le nom du plan est requis.",
  "admin.form.typeLabel": "Type de plan",
  "admin.form.typeRequired": "Le type de plan est requis.",
  "admin.form.typeImmutable": "Le type de plan ne peut pas être modifié.",
  "admin.form.descriptionLabel": "Description",
  "admin.form.descriptionPlaceholder": "Description du plan...",
  "admin.form.tariffsLegend": "Tarifs",
  "admin.form.prixMensuelLabel": "Prix mensuel",
  "admin.form.prixMensuelPlaceholder": "Ex: 3000",
  "admin.form.prixMensuelMin": "Le prix mensuel doit être >= 0.",
  "admin.form.prixTrimestrielLabel": "Prix trimestriel",
  "admin.form.prixTrimestrielPlaceholder": "Ex: 8000",
  "admin.form.prixTrimestrielMin": "Le prix trimestriel doit être >= 0.",
  "admin.form.prixAnnuelLabel": "Prix annuel",
  "admin.form.prixAnnuelPlaceholder": "Ex: 30000",
  "admin.form.prixAnnuelMin": "Le prix annuel doit être >= 0.",
  "admin.form.limitesLegend": "Limites",
  "admin.form.maxSitesLabel": "Sites max",
  "admin.form.maxTanksLabel": "Bacs max",
  "admin.form.maxBatchesLabel": "Vagues max",
  "admin.form.limitesBacsMin": "La limite de bacs doit être >= 1.",
  "admin.form.limitesVaguesMin": "La limite de vagues doit être >= 1.",
  "admin.form.limitesSitesMin": "La limite de sites doit être >= 1.",
  "admin.form.maxIngFermesLabel": "Fermes ingénieur max",
  "admin.form.maxIngFermesPlaceholder": "Ex: 5",
  "admin.form.limitesIngFermesMin": "La limite de fermes ingénieur doit être >= 1.",

...
export enum Permission {
  ...
  VAGUES_SUPPRIMER = "VAGUES_SUPPRIMER",
  ...
  VENTES_MODIFIER = "VENTES_MODIFIER",
  ...
  GENITEURS_VOIR = "GENITEURS_VOIR",
  GENITEURS_GERER = "GENITEURS_GERER",
  PONTES_VOIR = "PONTES_VOIR",
  PONTES_GERER = "PONTES_GERER",
  LOTS_ALEVINS_VOIR = "LOTS_ALEVINS_VOIR",
  LOTS_ALEVINS_GERER = "LOTS_ALEVINS_GERER",
  INCUBATIONS_VOIR = "INCUBATIONS_VOIR",
  INCUBATIONS_GERER = "INCUBATIONS_GERER",
  PLANNING_REPRODUCTION_VOIR = "PLANNING_REPRODUCTION_VOIR",
  // Planning
  ...
  PREVISIONS_SUPPRIMER = "PREVISIONS_SUPPRIMER",
}

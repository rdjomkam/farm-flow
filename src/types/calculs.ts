...
// FCRTracePeriode, FCRTraceVague, FCRTrace — DELETED (ADR-036 replaces ADR-031 dialog)
// Replaced by FCRBacPeriode, FCRByFeedVague, FCRByFeedResult in src/types/fcr-by-feed.ts

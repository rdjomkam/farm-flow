...
export const permissionLabels: Record<string, string> = {
  ...
  // Admin Plateforme (ADR-021) — reserve au Role.ADMIN global, jamais assignees via un SiteRole
  [Permission.SITES_VOIR]: "Voir les sites (plateforme)",
  [Permission.SITES_GERER]: "Gerer les sites (plateforme)",
  [Permission.ANALYTICS_PLATEFORME]: "Analytics plateforme",
  ...
  [Permission.VAGUES_SUPPRIMER]: "Supprimer des vagues",
  ...
  [Permission.RELEVES_SUPPRIMER]: "Supprimer des releves",
  ...
  [Permission.VENTES_MODIFIER]: "Modifier des ventes (creer/signer un bon de livraison)",
  ...
  [Permission.PAIEMENTS_SUPPRIMER]: "Supprimer des paiements",
  // Bons de livraison rectificatifs (Sprint BF phase 2) — cf. story SU.8 (arbitrage en cours)
  [Permission.BONS_LIVRAISON_RECTIFIER]: "Rectifier un bon de livraison signe",
  [Permission.ALEVINS_VOIR]: "Voir les alevins (acces module Reproduction)",
  ...
  // Reproduction — permissions granulaires (ADR-045)
  [Permission.GENITEURS_VOIR]: "Voir les geniteurs",
  [Permission.GENITEURS_GERER]: "Gerer les geniteurs",
  [Permission.PONTES_VOIR]: "Voir les pontes",
  [Permission.PONTES_GERER]: "Gerer les pontes",
  [Permission.LOTS_ALEVINS_VOIR]: "Voir les lots d'alevins",
  [Permission.LOTS_ALEVINS_GERER]: "Gerer les lots d'alevins",
  [Permission.INCUBATIONS_VOIR]: "Voir les incubations",
  [Permission.INCUBATIONS_GERER]: "Gerer les incubations",
  [Permission.PLANNING_REPRODUCTION_VOIR]: "Voir le planning Reproduction",

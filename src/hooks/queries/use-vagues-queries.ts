...
import type { VagueSummaryResponse, VagueDetailResponse, VagueListResponse, CreateVagueDTO, UpdateVagueDTO } from "@/types";
...
export function useVaguesList(
  ...
  return useQuery({
    ...
    queryFn: async () => {
      ...
      return (result.data as VagueListResponse).data;
    },

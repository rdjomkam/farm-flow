...
export function construireRapprochementDTO(
  ...
  return {
    ...
    totalMoisMonetaireParMois: mapVersRecord(vue.totalMoisMonetaireParMois, (a: AgregatMois) => versAgregatEcartDTO(a)),
    totalMoisQuantiteParMois: mapVersRecord(vue.totalMoisQuantiteParMois, (a: AgregatMois) => versAgregatEcartDTO(a)),
    nonRapprocheParMois: mapListeVersRecord(vue.nonRapprocheParMois, versLigneDTO),
    cumuleGlobalMonetaireParMois: mapVersRecord(vue.cumuleGlobalMonetaireParMois, versAgregatEcartDTO),
    cumuleGlobalQuantiteParMois: mapVersRecord(vue.cumuleGlobalQuantiteParMois, versAgregatEcartDTO),
    cumuleParPosteParMois: mapListeVersRecord(vue.cumuleParPosteParMois, versAgregatPosteDTO),
    topEcartsMonetaireParMois: mapListeVersRecord(vue.topEcartsMonetaireParMois, versLigneDTO),
    topEcartsQuantiteParMois: mapListeVersRecord(vue.topEcartsQuantiteParMois, versLigneDTO),

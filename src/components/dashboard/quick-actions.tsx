...
const baseActions: QuickAction[] = [
  { href: "/releves/nouveau", labelKey: "nouveauReleve", icon: PlusCircle, bgClass: "bg-primary/10", iconColor: "text-primary", permission: Permission.RELEVES_CREER },
  { href: "/mes-taches", labelKey: "mesTaches", icon: ClipboardCheck, bgClass: "bg-accent-green-muted", iconColor: "text-accent-green", permission: Permission.PLANNING_VOIR },
  { href: "/vagues", labelKey: "voirVagues", icon: Waves, bgClass: "bg-accent-blue-muted", iconColor: "text-accent-blue", permission: Permission.VAGUES_VOIR },
  { href: "/factures", labelKey: "factures", icon: FileText, bgClass: "bg-accent-amber-muted", iconColor: "text-accent-amber", permission: Permission.FACTURES_VOIR },
  { href: "/stock", labelKey: "stock", icon: Package, bgClass: "bg-accent-purple-muted", iconColor: "text-accent-purple", permission: Permission.STOCK_VOIR },
];
...
export function QuickActions({ permissions }: QuickActionsProps) {
  ...
  return (
    <section>
      <h2 className="text-[11px] font-semibold uppercase tracking-wider text-muted-foreground mb-2">{t("title")}</h2>

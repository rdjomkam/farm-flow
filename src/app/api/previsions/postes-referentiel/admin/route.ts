 ...
 * `PREVISIONS_VOIR`, consommee par les formulaires de selection) — cette
 * route sert exclusivement l'ecran d'administration
 * `/previsions/postes-referentiel`, permission `PREVISIONS_PARAMETRER`
 * (paramétrage de structure, pas saisie de valeurs au jour le jour).
 *

/**
 * GET /api/admin/analytics/revenus — Decomposition mensuelle des revenus confirmes.
 *
 * Guards :
...
export async function GET(request: NextRequest) {
  try {
    ...
    // 4. Recuperer les donnees de revenus
    ...
    console.error("[GET /api/admin/analytics/revenus]", error);
    return NextResponse.json(

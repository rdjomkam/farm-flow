...
export async function POST(request: NextRequest, { params }: Params) {
  try {
    ...
    return handleApiError("POST /api/depenses/[id]/paiements", error, "Erreur serveur lors de l'enregistrement du paiement.", {
      statusMap: [{ match: "entierement payee", status: 409 }],
    });
  }
}

...
async function loadMessages(locale: Locale): Promise<Record<string, unknown>> {
  const namespaces = ["common", "format", "navigation", "permissions", "abonnements", "settings", "analytics", "errors", "stock", "ventes", "vagues", "releves", "alevins", "users", "commissions", "activites", "admin", "alertes", "backoffice", "bacs", "besoins", "calibrage", "config-elevage", "dashboard", "depenses", "ingenieur", "layout", "maintenance", "notes", "observations", "packs", "planning", "pwa", "remises", "sites", "reproduction"];
